  <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <div class="container">
                ...
                @endif
                    <form method="POST" action="{{ route('web.customer.store') }}" id="expenseStoreForm"
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Yeni Müşteri Ekleme Sayfası</h4>
                                    </div>
                                    <div class="card-body">
                                        <p>* Zorunlu alanlar.</p>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input class="form-control is-invalid " type="date" id="date" name="date">
                                                </div>
                                            </div>
                                        </div>
